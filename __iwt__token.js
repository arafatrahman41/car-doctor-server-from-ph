 ...
 * 3. refresh token is used: to recreate an access token that was expired. if refresh is invalid then logout the user
 * 
 * **/
 ...
 * 3. req.cookies
 * 4. on the client side: make api call using axios withCredentials: true (or credentials includes while using fetch)
 * 5.
 * 
 * **/